...
ALTER TABLE oauth2_access ALTER COLUMN created_at TYPE timestamp without time zone;
ALTER TABLE oauth2_access ALTER COLUMN created_at SET DEFAULT now() at time zone 'utc';

ALTER TABLE oauth2_authorize ALTER COLUMN created_at TYPE timestamp without time zone;
ALTER TABLE oauth2_authorize ALTER COLUMN created_at SET DEFAULT now() at time zone 'utc';
...
create table oauth2_refresh(
    ...
    oauth2_access_id bigint not null
);
...
alter table oauth2_refresh add constraint fk_access_id foreign key (oauth2_access_id) references oauth2_access(id);
